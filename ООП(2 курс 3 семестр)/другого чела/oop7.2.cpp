...
int main()
{
	...
	{
		Airline d("Name"+to_string(i), "c"+ to_string(i), "https://arline-" + to_string(i*30) + ".com", i*100, i*10, 10-i/5);
		T.push(d);
	}
	cout << * T[0];
